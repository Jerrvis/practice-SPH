  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trademark in trademarkList" :key="trademark.tmId" @click="addTrademark(trademark)">{{trademark.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(attrValue,index) in attr.attrValueList" :key="index">
            <a @click="addAttr(attr.attrId,attrValue,attr.attrName)">{{attrValue}}</a>
          </li>
        </ul>
      </div>
...
export default {
  ...
  setup(props,{ emit }) {
    ...
    // 添加品牌名
    function addTrademark (trademark){
      emit("trademarkInfo",trademark)
    }
    // 添加售卖属性
    function addAttr (attrId,attrValue,attrName){
      let attrData = attrId+':'+attrValue+':'+attrName;
      bus.emit("attrInfo", attrData)
    }
